...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
  ...
  modifier forSale(uint _sku) {
    //preferred to have price check first to exploit short-circuiting
    require(items[_sku].buyer == address(0) && items[_sku].state == State.ForSale);
    _;
  }
  ...
  is the buyer. Change the state of the item to be received. Remember to call the event associated with this function!*/
